-- Ensure the 'restaurant' table exists
...
-- Insert well-known UUIDs for specific restaurants
INSERT INTO restaurant (id, name, email, address, date_of_birth, registered_date)
...
SELECT '223e4567-e89b-12d3-a456-426614174005',
       ...
       '1988-07-25',
       '2024-02-15'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174005');
...
SELECT '223e4567-e89b-12d3-a456-426614174006',
       ...
       '1992-04-18',
       '2023-08-25'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174006');
...
SELECT '223e4567-e89b-12d3-a456-426614174007',
       ...
       '1975-01-11',
       '2022-10-10'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174007');
...
SELECT '223e4567-e89b-12d3-a456-426614174008',
       ...
       '1989-09-02',
       '2024-04-20'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174008');
...
SELECT '223e4567-e89b-12d3-a456-426614174009',
       ...
       '1993-11-15',
       '2023-06-30'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174009');
...
SELECT '223e4567-e89b-12d3-a456-426614174010',
       ...
       '1980-08-09',
       '2023-01-22'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174010');
...
SELECT '223e4567-e89b-12d3-a456-426614174011',
       ...
       '1984-05-03',
       '2024-05-12'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174011');
...
SELECT '223e4567-e89b-12d3-a456-426614174012',
       ...
       '1991-12-25',
       '2022-11-11'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174012');
...
SELECT '223e4567-e89b-12d3-a456-426614174013',
       ...
       '1976-06-08',
       '2023-09-19'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174013');
...
SELECT '223e4567-e89b-12d3-a456-426614174014',
       ...
       '1987-10-17',
       '2024-03-29'
WHERE NOT EXISTS (SELECT 1 FROM restaurant WHERE id = '223e4567-e89b-12d3-a456-426614174014');
